...
<div class="container-fluid row" style="margin-top: 60px;text-align: center;">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h2 style="font-family:got;color: white;margin-bottom: 50px;margin-top: 15px;">
            Sponsors
        </h2>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" style="font-family:got;color: #018EBE;">
        MAIN SPONSOR
        <img src="<?php echo _SITE_CSS . "img/logo_uipath.png"; ?>" style="height: 100%;width: 100%;max-height: 140px;max-width: 300px;text-align: center;">
    </div>
